...
: ${KAFKA_CONNECT_REST_ADVERTISED_HOST_NAME:=$HOST}
: ${KAFKA_CONNECT_REST_ADVERTISED_PORT:=$PORT0}
...
: ${KAFKA_CONNECT_STATUS_STORAGE_TOPIC:=__connect-status}
: ${KAFKA_CONNECT_OFFSET_FLUSH_INTERVAL_MS:=60000}
: ${KAFKA_CONNECT_HEARTBEAT_INTERVAL_MS:=3000}
: ${KAFKA_CONNECT_SESSION_TIMEOUT_MS:=30000}
